...
label yuri_kill_3:
    ...
    m "给我一点点时间..."
    $ consolehistory = []
    call updateconsole("os.remove(\"characters/yuri.chr\")", "ACCESS DENIED: No permission")
    pause 1.0
    call updateconsole("os.remove(\"characters/natsuki.chr\")", "ACCESS DENIED: No permission")
    pause 1.0
